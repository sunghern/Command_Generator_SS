...
bool pimblasAddPreprocess(struct PimCmdMetadata *cmd_metadata, int len, uint8_t **in0, uint8_t **in1);
...
bool pimblasBn1dPreprocess(PIMKernel *micro_kernel, int len_batch, int len_feature, uint8_t **weight_mul,
						   uint8_t **weight_add);
bool pimblasGemvPreprocess(struct PimCmdMetadata *cmd_metadata0, PimCmdMetadata *cmd_metadata1, int len_in,
						   int len_out, uint8_t **w);
...
bool pim_gemv(struct PimCmdMetadata cmd_metadata0, struct PimCmdMetadata cmd_metadata1, int m, int n,
